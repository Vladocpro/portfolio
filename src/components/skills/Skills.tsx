...
const Skills = () => {
   ...
   return (
       <div className="h-[100dvh] flex flex-col snap-start scroll-smooth pt-5 xl:pt-0" id="skills">
          ...
          <div
              className={`flex flex-col items-center justify-center gap-3 h-full relative overflow-hidden  rounded-xl transition-all duration-1000  ${inView ? "delay-[125ms] shadow-all-xl shadow-gray-400" : "shadow-none"}`}
