          ...
          <div className="flex flex-col h-full" ref={ref}>
             ...
             <div ref={scope} className={`flex flex-col mt-6 mx-1 px-3 lg:h-[194px] py-2 rounded-md shadow-all-lg shadow-gray-400 transition-all duration-500 ${inView ? "delay-[125ms] translate-y-0 opacity-100" : "translate-y-1/2 opacity-0"}`}>
                ...
                <div className="flex justify-between items-center">
                   <div className={`flex gap-1 ${projectData.demoAccount ? "mt-0" : "mt-3"}`}>
                      ...
                      </a>
                      {
                         projectData.website !== undefined ? (
                             <a href={projectData.website} rel="noreferrer noopener" target="_blank">
                                ...
                                {/*</svg>*/}
                                {/*<svg xmlns="http://www.w3.org/2000/svg"*/}
                                {/*     className={`w-[35px] sm:w-[40px] cursor-pointer stroke-white transition-all duration-200 hover:stroke-gray-500 hover:scale-110`}*/}
                                ...
                                {/*</svg>*/}
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className={`w-[30px] sm:w-[35px] mt-1 sm:mt-0.5 cursor-pointer stroke-white transition-all duration-200 hover:stroke-gray-500 hover:scale-110`}
                                ...
                                {/*<svg xmlns="http://www.w3.org/2000/svg"*/}
                                {/*     className={`w-[35px] sm:w-[35px] sm:mt-0.5 cursor-pointer stroke-white transition-all duration-200 hover:stroke-gray-500 hover:scale-110`}*/}
